<div class="card card-body">
    <form action="{{route('card.create')}}" method="POST">
        ...
        <div class="row row-cols-1 mb-3 mt-3 justify-content-center">
            ...
            <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-10 col-xs-10 mb-lg-3 mb-md-4 mb-sm-5 card_input">
            ...
            <div class="col col-xl-3 col-lg-3 col-md-6 col-sm-10 mb-lg-3 mb-md-4 mb-sm-5 card_input">
                ...
                <select name="pet[kind_id]" class="form-control text-start @error('pet.kind_id') is-invalid @enderror">
                    @foreach($kinds as $kind)
                        <option class="mb-sm-5" @if($kind->id == session()->getOldInput('pet.kind_id')) selected @endif value="{{$kind->id}}" >{{$kind->kind}}</option>
                    @endforeach
                </select>
            </div>
            <div class="col col-xl-3 col-lg-3 col-md-6 col-sm-10 mb-lg-3 mb-md-4 mb-sm-5 card_input">
        ...
        <button type="submit" class="btn btn-primary m-3 m-auto"><i class="bi bi-plus-lg"></i> Создать</button>
    </form>
</div>
