<form action="{{route('owners.update', ['id'=>$owner->id])}}" method="POST">
    ...
    <div class="row row-cols-auto mb-3 mt-3 justify-content-center">
        ...
        <div class="col col-xl-3 col-lg-3 col-md-6 col-sm-10 mb-lg-3 mb-md-4 mb-sm-5 xs-w-9 xs-mb-3">
            <label for="additional_phone">{{__('cards.view.create.form.owner.fields.additionalPhone.label')}}</label>
        ...
        <div class="col col-xl-3 col-lg-3 col-md-6 col-sm-10 mb-lg-3 mb-md-4 mb-sm-5 xs-w-9 xs-mb-3">
            ...
            <input type="text" class="form-control @error('email') is-invalid @enderror"
                   id="email"
                   name="email" placeholder="{{__('cards.view.create.form.owner.fields.email.placeholder')}}" aria-label="email"
                   maxlength="50"
                   minlength="5"
